...
import id.hengker.cihuyy.R
import id.hengker.cihuyy.ui.MapActivity
...
class RouteWalkService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "id.hengker.cihuyy.WALK_START"
        const val ACTION_PAUSE = "id.hengker.cihuyy.WALK_PAUSE"
        const val ACTION_RESUME = "id.hengker.cihuyy.WALK_RESUME"
        const val ACTION_STOP = "id.hengker.cihuyy.WALK_STOP"

        const val BROADCAST_PROGRESS = "id.hengker.cihuyy.WALK_PROGRESS"
        const val BROADCAST_FINISHED = "id.hengker.cihuyy.WALK_FINISHED"
        const val BROADCAST_STATE = "id.hengker.cihuyy.WALK_STATE"

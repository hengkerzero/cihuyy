...
import io.github.jqssun.gpscihuyy.databinding.ActivitySettingsBinding
    ...
    class SettingsPreferenceFragment : PreferenceFragmentCompat() {
        ...
        private fun isJoystickRunning(): Boolean {
            ...
            for (service in manager.getRunningServices(Int.MAX_VALUE)) {
                if ("io.github.jqssun.io.github.hengkerzero.gpscihuyy.utils.JoystickService" == service.service.className) {
                    isRunning = true
                }
            }
            return isRunning
